...
// module
exports.push([module.i, ".operator-container {\n  text-align: center;\n  height: 50px;\n  line-height: 50px; }\n\ncanvas {\n  background-color: lightblue;\n  display: block;\n  margin: 0 auto; }\n\n#run_game {\n  width: 337px;\n  height: 75px;\n  margin: 0 auto;\n  position: relative;\n  top: -280px;\n  background: url(" + escape(__webpack_require__(/*! ../img/gamebegin.png */ "./src/img/gamebegin.png")) + ");\n  cursor: pointer; }\n", ""]);
...
var Background = __webpack_require__(/*! ./Background */ "./src/js/Background.js");

var Pipe = __webpack_require__(/*! ./Pipe */ "./src/js/Pipe.js");
...
class Game {
  ...
  mainloop() {
    ...
    this.ctx.clearRect(0, 0, this.casDom.width, this.casDom.height); //房子更新、渲染

    this.fangzi.update();
    this.fangzi.render(); //地板更新、渲染

    this.diban.update();
    this.diban.render(); //大树的更新、渲染
    ...
    this.frameUtil.update(); //遍历所有的管子，让所有的管子都更新、渲染
...
class Pipe {
  constructor({
    ...
    this.game = gameIns; //0表示管子向上、1表示管子向下。

    this.type = _.random(0, 1); //管子的高度

    this.h = _.random(100, this.game.casDom.height / 2); //x位置

    this.x = this.game.casDom.width; //y位置

    this.y = this.type == 0 ? this.game.casDom.height - this.h - 44 : 0; //宽度
...
const $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // let ctx = $("canvas")[0].getContext("2d");
...
runGame.click(() => {
  window.ctrl = new Controller(new _Game_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
    fps: 16,
    casDom: $("canvas")[0]
  }));
